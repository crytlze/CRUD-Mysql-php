...
$pdf->Image('../logo/yasha.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS Gudang Pangan',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. KIOS Gudang Pangan',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.Gudang Pangan.com email : Gudang Pangan@gmail.com',0,'L');
